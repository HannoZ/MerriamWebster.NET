namespace MerriamWebster.NET.Dto
{
    ...
    /// The second part of the sense is contained in a <see cref="DividedSense"/>, consisting of a <see cref="SenseDivider"/> along with a second <see cref="SenseBase.Text"/>.
    /// </summary>
    /// <remarks>
